...
The birth series of Fig.~\ref{fig:foldout} highlights the matched deviations in the size of cohorts and offspring. Neither these nor the larger scale varieties of cyclicity, such as those that appear through the \nth{20} Century in Sweden are described at length herein. 
