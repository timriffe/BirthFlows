...
shift over $x$. The births over the life of a cohort often resemble the smoothness of fertility rate schedules.}
\end{figure}
...
The birth series of Fig.~\ref{fig:foldout} highlights the matched deviations in the size of cohorts and offspring, which make the series appear to vibrate. We describe neither these nor the larger scale varieties of cyclicity, such as those that appear through the \nth{20} Century in Sweden are described. We have not found literature on the mirrored pattern of single-year deviations in cohort and offspring size, but there is a literature that seeks to understand the periodic fluctuations in birth cohort size \citep[This literature largely derives from][]{lee1974formal}, and more often the effect of demographic cycles on society.
